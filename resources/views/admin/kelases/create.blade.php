...
<div class="main-card">
    <div class="header">
        {{ trans('global.create') }} {{ trans('cruds.kelase.title_singular') }}
    </div>
        ...
        <div class="body">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="nama_kelas" name="nama_kelas" class="{{ $errors->has('nama_kelas') ? ' ' : '' }}" value="{{ old('nama_kelas') }}" required>
                </div>
