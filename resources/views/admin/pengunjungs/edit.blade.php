...
<div class="main-card">
    ...
    <form method="POST" action="{{ route("admin.pengunjungs.update", [$pengunjung->id]) }}" enctype="multipart/form-data">
        @method('PUT')
        @csrf
        <div class="body">
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="text" id="nama_pengunjung" name="nama_pengunjung" class="{{ $errors->has('nama_pengunjung') ? ' ' : '' }}" value="{{ old('nama_pengunjung', $pengunjung->nama_pengunjung) }}" required>
                </div>
